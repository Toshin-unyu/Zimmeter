...
export const TaskButton = ({ category, isActive, onClick, onDoubleClick, className }: TaskButtonProps) => {
  ...
  return (
    <button
      ...
      style={style}
      className={clsx(
        "flex flex-col items-center justify-center p-2 rounded-xl border-2 transition-all w-full h-14 sm:h-24 shadow-sm hover:shadow-md cursor-pointer hover:brightness-95",
        colorClass,
